...
export const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  return (
    <aside className={`bg-white border-r border-gray-200 h-screen transition-all duration-300 ${isCollapsed ? 'w-16' : 'w-64'}`}>
      <div className="h-full flex flex-col justify-between">
        ...
        <div className="p-4">
          ...
          {isCollapsed && (
            <Tooltip content="Create New Note" position="right">
              <Link href="/notes/create">
